...
export default class SelectMultiple extends Component {
  static propTypes = {
    ...
    checkboxView: PropTypes.object,
    selectedCheckboxView: PropTypes.object,
  ...
  renderItemRow = row => {
    ...
    if (row.selected) {
      ...
      if (selectedCheckboxView) {
        checkboxViewComponent = selectedCheckboxView;
      } else {
      ...
      if (checkboxView) {
        checkboxViewComponent = checkboxView;
      } else {
        checkboxViewComponent = (
          <Image style={checkboxStyle} source={checkboxSource} />
        );
